...
// Where the daemon finds a repo, nothing more: the repo's own run config
// (allowlist override, check command) is versioned with it in
// `.helm/config.json` (`repo-config.ts`).
